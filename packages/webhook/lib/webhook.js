...
const hashWebhookMessage = (serialized) =>
  (0, solidity_1.keccak256)(
    ["string", "bytes"],
    ["/zero/1.1.0/webhook", serialized]
  );
    ...
    const result = await axios_1.default.post(
      ...
      request.toPlainObject(),
      {
        headers: {
          ...
          "X-Signature": await this.signer.signMessage(
            (0, exports.hashWebhookMessage)(request.serialize())
          ),
        },
      }
    );

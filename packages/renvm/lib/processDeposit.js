...
const processDeposit = async (fromChain, toChain, inputTx, asset, to, shard, _nonce) => {
    ...
    let payload = await toChain.getOutputPayload(asset, inputType, outputType, to);
    ...
    const gPubKey = utils_1.utils.fromBase64(shard);
    ...
    return await (0, exports.getPack)(selector, {

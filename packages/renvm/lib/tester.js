...
(async () => {
    ...
    const paramsAlo = {
        ...
        payload: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEAAAAAAAAAAAAAAAABsE_oSAVGsH0OCK61818Q8-zr39AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAADQlRDAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
    ...
    const result = await (0, transaction_1.getTxDetails)("Bitcoin", paramsAlo, asset, selector);
    console.log(result);
})();

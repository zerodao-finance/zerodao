...
class Request {
  ...
  serialize() {
    return buffer_1.Buffer.from(
      (0, bytes_1.arrayify)(
        (0, rlp_1.encode)(this.constructor.FIELDS.map((v) => this[v]))
      )
    );
  }
  static deserialize(data) {
    ...
    return new RequestType(
      (0, rlp_1.decode)(data).reduce((r, v, i) => {
  ...
  getChainId() {
    return Number(
      Object.keys(protocol_1.default).find((v) =>
        Object.keys(protocol_1.default[v]).find((network) =>
          Object.keys(protocol_1.default[v][network].contracts).find(
            (contract) =>
              [
              ...
              (0, address_1.getAddress)(
                protocol_1.default[v][network].contracts[contract].address
    ...
    (async () => {
      for (const keeper of peer._keepers) {
        try {
          ...
          (0, it_pipe_1.default)(
            request,
            it_length_prefixed_1.default.encode(),
            stream.sink
          );

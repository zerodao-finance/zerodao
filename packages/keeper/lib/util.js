...
exports.serializeToJSON =
  exports.handleRequestsV21 =
  exports.handleRequestsV2 =
  exports.handleRequestsV1 =
  exports.pipeToBuffer =
  exports.pipeToString =
  exports.advertiseAsKeeper =
  exports.fromJSONtoBuffer =
    void 0;
...
async function pipeToString(stream) {
  return await new Promise((resolve, reject) => {
    (0, it_pipe_1.default)(
      stream.source,
      it_length_prefixed_1.default.decode(),
      async (rawData) => {
        const string = [];
        try {

...
exports.getProvider =
  exports.getRenVMChain =
  exports.getVanillaProvider =
...
const getVanillaProvider = (request) => {
  const checkSummedContractAddr = (0, address_1.getAddress)(
    request.contractAddress
  );
  if (
    Object.keys(exports.CONTROLLER_DEPLOYMENTS).includes(
      checkSummedContractAddr
    )
  ) {
...
const getProvider = (transferRequest) => {
  const checksummedAddr = (0, address_1.getAddress)(
    transferRequest.contractAddress
  );
  const ethersProvider = (0, exports.getVanillaProvider)(transferRequest);

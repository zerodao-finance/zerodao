...
exports.reverseTokenMapping =
  exports.tokenMapping =
  exports.chainIdToNetworkName =
  exports.getChainIdToName =
  exports.getChainUnits =
  exports.selectFixture =
    void 0;
...
function reverseTokenMapping({ tokenAddress, chainId }) {
  const checksummedAddress = (0, address_1.isAddress)(tokenAddress)
    ...
    : "";
  const fixture = selectFixture(chainId);
  if (checksummedAddress == constants_1.AddressZero) return "ETH";
  let tokenName = lodash_1.default.findKey(fixture, function (v) {
    return (0, address_1.getAddress)(v) == checksummedAddress;
  });
  return tokenName;
}

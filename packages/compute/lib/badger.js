...
exports.makeCompute = exports.renVmFee = exports.mintFee = exports.burnFee = void 0;
...
exports.burnFee = ethers.utils.parseEther("0.004");
exports.mintFee = ethers.utils.parseEther("0.0025");
exports.renVmFee = ethers.utils.parseEther("0.0015");
const makeCompute = (CHAIN = "1") => {
    ...
    const deductBurnFee = async (amount, multiplier) => {
        ...
        const feeAmounts = await applyFee(amount, exports.burnFee, multiplier);
    ...
    const deductMintFee = async (amount, multiplier) => {
        amount = ethers.BigNumber.from(amount);
        const feeAmounts = await applyFee(amount, exports.mintFee);
        const amountAfterDeduction = amount.sub(feeAmounts.totalFees);
        return amountAfterDeduction <= 0 ? 0 : amountAfterDeduction;
    };
    ...
    const applyFee = async (amountIn, burnFee, multiplier) => {
        ...
        const renVmFeeAmt = applyRatio(amountIn, exports.renVmFee);

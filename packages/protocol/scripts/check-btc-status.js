...
} = require("../deployments/matic/BTCVault.json");
const {
  abi: SwapAbi,
  address: SwapAddress,
} = require("../deployments/matic/Swap.json");
const {
  abi: StrategyAbi,
  address: StrategyAddress,
} = require("../deployments/matic/StrategyRenVM.json");
const {
  abi: underwriterAbi,
...
signer.getGasPrice = require("ethers-polygongastracker").createGetGasPrice(
  "rapid"
);
...
const underwriterImpl = new ethers.Contract(
  underwriterAddress,
  ControllerAbi,
  wallet
);

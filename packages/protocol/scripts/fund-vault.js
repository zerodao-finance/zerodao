...
const main = async () => {
  ...
  const RenBTC = await new ethers.Contract(
  ...
  const yVault = await new ethers.Contract(
    "0x55C7A6b140A31271ACFC8f715e08B497a774784E",
    abi,
    wallet
  );
  ...
  console.log(
    ethers.utils.formatUnits(
      await yVault.balanceOf("0x3A9145b3A840D70650FFA483461468415C4B7bed")
    )
  );

...
describe("ModuleFeesCoder.sol", () => {
  ...
  describe("decode", () => {
    it("Should be able to get min/max values", async () => {
      await externalModuleFees.encode(
        "0x03",
        "0x00",
        "0xff",
        "0x00",
      ...
      const {
        ...
        btcFeeForRepayGas,
        lastUpdateTimestamp,
      } = await externalModuleFees.decode();
  ...
  describe("getLoanParams", () => {
    it("Should be able to get min/max values", async () => {
      ...
      const { moduleType, ethRefundForLoanGas } =
        await externalModuleFees.getLoanParams();
      expect(moduleType).to.eq("0x03");
      expect(ethRefundForLoanGas).to.eq("0x00");
    });
  ...
  describe("getBitcoinGasFees", () => {
    it("Should be able to get min/max values", async () => {
      ...
      const { btcFeeForLoanGas, btcFeeForRepayGas } =
        await externalModuleFees.getBitcoinGasFees();
      expect(btcFeeForLoanGas).to.eq("0xffffff");
      expect(btcFeeForRepayGas).to.eq("0x00");
    });
  ...
  describe("setRepayParams", () => {
    it("Reverts when ethRefundForRepayGas overflows", async () => {
      await expect(
        externalModuleFees.setRepayParams(
          "0x00",
          "0x01ffffffffffffffff",
          "0x00"
        )
  ...
  describe("getRepayParams", () => {
    it("Should be able to get min/max values", async () => {
      ...
      const { moduleType, ethRefundForRepayGas, btcFeeForRepayGas } =
        await externalModuleFees.getRepayParams();
      expect(moduleType).to.eq("0x03");
      expect(ethRefundForRepayGas).to.eq("0x00");
      expect(btcFeeForRepayGas).to.eq("0xffffff");
    });
  ...
  describe("getCached", () => {
    it("Should be able to get min/max values", async () => {
      ...
      const {
        ...
        btcFeeForRepayGas,
        lastUpdateTimestamp,
      } = await externalModuleFees.getCached();
      expect(ethRefundForLoanGas).to.eq("0xffffffffffffffff");
      expect(ethRefundForRepayGas).to.eq("0x00");
      expect(btcFeeForLoanGas).to.eq("0xffffff");
      expect(btcFeeForRepayGas).to.eq("0x00");
  ...
  describe("getEthRefundForLoanGas", () => {
    it("Should be able to get min value", async () => {
      ...
      const ethRefundForLoanGas =
        await externalModuleFees.getEthRefundForLoanGas();
      expect(ethRefundForLoanGas).to.eq("0xffffffffffffffff");
    });
  ...
  describe("getEthRefundForRepayGas", () => {
    it("Should be able to get min value", async () => {
      ...
      const ethRefundForRepayGas =
        await externalModuleFees.getEthRefundForRepayGas();
      expect(ethRefundForRepayGas).to.eq("0xffffffffffffffff");
    });
  ...
  describe("getLastUpdateTimestamp", () => {
    it("Should be able to get min value", async () => {
      ...
      const lastUpdateTimestamp =
        await externalModuleFees.getLastUpdateTimestamp();
      expect(lastUpdateTimestamp).to.eq("0xffffffff");
    });

...
class Dispatcher {
    constructor({ redis, gasLimit, logger, signer }) {
        ...
        this.signers = Object.entries(this.constructor.RPC_ENDPOINTS).reduce((r, [key, value]) => {
            r[key] = (NO_FLASHBOTS[key] ? (v) => v : (v) => (0, ethers_flashbots_1.makePrivateSigner)({ signer: v, getMaxBlockNumber: async (signer) => ((await signer.provider.getBlockNumber()) + 10000) }))(signer.connect(this.makeProvider(key)));
            return r;
        }, {});
    }

...
class Consensus extends EventEmitter {
  ...
  L22(value) {
    ...
    if (
      !this.hasLogs(
        rule,
        ((_a = this.messageLog) === null || _a === void 0
          ? void 0
          : _a[this.proposer()]) || {}
      )
    )
  ...
  L34() {
    ...
    if (
      ((_b =
        (_a = this.messageLog) === null || _a === void 0 ? void 0 : _a.L34) ===
        null || _b === void 0
        ? void 0
        : _b[this.round]) !== undefined ||
      this.step !== PREVOTE
    )
      return;
  ...
  L36() {
    ...
    if (
      ((_b =
        (_a = this.messageLog) === null || _a === void 0 ? void 0 : _a.L36) ===
        null || _b === void 0
        ? void 0
        : _b[this.round]) !== undefined
    )
    ...
    if (
      !this.hasLogs(
        rule,
        ((_c = this.messageLog) === null || _c === void 0
          ? void 0
          : _c[this.proposer()]) || {}
      )
    )
  ...
  L47() {
    ...
    if (
      ((_b =
        (_a = this.messageLog) === null || _a === void 0 ? void 0 : _a.L47) ===
        null || _b === void 0
        ? void 0
        : _b[this.round]) !== undefined
    )
  ...
  L49() {
    ...
    if (
      ((_b = this.decision) === null || _b === void 0
        ? void 0
        : _b[this.height]) !== undefined
    )

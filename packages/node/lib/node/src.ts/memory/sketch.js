...
class Sketch {
  static init(capacity) {
    return __awaiter(this, void 0, void 0, function* () {
      return new this({
        sketch: yield libminisketch_wasm_1.Minisketch.create({
          fieldSize: 64,
          capacity,
        }),
        capacity,
  ...
  storeTx(txHash, addToSketch = true) {
    const sketchValue = ethers_1.ethers.BigNumber.from(
      ethers_1.ethers.utils.arrayify(txHash).slice(24, 32)
    ).toString();
  ...
  calculateDifferences(serializedSketch) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const [length, res] = (0, libminisketch_wasm_1.resolve)(
        (0, lodash_1.chunk)(this._sketch.decode(), 8)
      );
      if (length < 0) {

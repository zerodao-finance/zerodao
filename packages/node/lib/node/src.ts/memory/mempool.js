...
class Mempool {
  static init(config) {
    return __awaiter(this, void 0, void 0, function* () {
      const sketch = yield libminisketch_wasm_1.Minisketch.create({
        fieldSize: 64,
        capacity: 20,
      });
  ...
  start() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.running = true;
      yield this.peer.pubsub.subscribe(this.POOL_GOSSIP_TOPIC, (msg) =>
  ...
  validate(tx) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        yield (0, transaction_1.validateTransaction)(tx);
      } catch (error) {
        throw error;
      }
  ...
  cleanup() {
    return __awaiter(this, void 0, void 0, function* () {
      //TODO:
      // this.sketch.destroy();
      this.sketch = yield sketch_1.Sketch.init(20);
    });
  }
  ackGossip(message) {
    return __awaiter(this, void 0, void 0, function* () {

  ...
  runTransaction(tx) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const newFromAccount = Object.assign(
          Object.assign({}, oldFromAccount),
          { address: tx.from, balance: fromBalance }
        );
        const oldToAccount = yield this.trie.getAccount(tx.to);
        const toBalance = Number(oldToAccount.balance) + Number(tx.amount);
        const newToAccount = Object.assign(Object.assign({}, oldToAccount), {
          address: tx.to,
          balance: toBalance,
        });

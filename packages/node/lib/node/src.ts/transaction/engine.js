        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tx.type == "Stake") {
                try {
                    ...
                    const oldBalance = yield this.trie.getStakeBalance(ethers_1.default.utils.solidityKeccak256(["address"], [tx.address]));
                    ...
                    yield this.trie.setStakeBalance(ethers_1.default.utils.solidityKeccak256(["address"], [tx.address]), newBalance);
                    yield this.trie.trie.commit();
                }
                catch (error) {
                    yield this.trie.trie.revert();

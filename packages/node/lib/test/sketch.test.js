...
const sketch_1 = require("../src.ts/memory/sketch");
...
describe("Sketch", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        sketch = yield sketch_1.Sketch.init(5);
    }));
    ...
    it("should calculate differences between two sketches", () => __awaiter(void 0, void 0, void 0, function* () {
        const sketchNew = yield sketch_1.Sketch.init(5);
        sketchNew.storeTx(txHashes[1]);
        sketchNew.storeTx(txHashes[2]);
        const otherSketch = yield sketch_1.Sketch.init(5);
        ...
        (0, chai_1.expect)(found).to.contain(txHashes[1]);
        (0, chai_1.expect)(found).to.contain(txHashes[2]);
        (0, chai_1.expect)(missing).to.eql([]);
        (0, chai_1.expect)(rebuild).to.be.equal(false);
    }));
});

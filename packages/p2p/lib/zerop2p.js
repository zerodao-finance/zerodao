...
const mapToBuffers = (o) =>
  (0, lodash_1.mapValues)(o, (v) =>
    base64url(
      (v.toByteArray && buffer_1.Buffer.from(v.toByteArray())) ||
...
const cryptoFromSeed = async function (seed) {
  ...
  key.dq = key.dmq1;
  key.qi = key.coeff;
  return libp2p_crypto_1.default.keys.supportedKeys.rsa.unmarshalRsaPrivateKey(
    new libp2p_crypto_1.default.keys.supportedKeys.rsa.RsaPrivateKey(
      key,
      key
    ).marshal()
  );
